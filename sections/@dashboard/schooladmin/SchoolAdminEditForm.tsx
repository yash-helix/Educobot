...
type Props = {
  isEdit?: boolean;
  currentSchoolAdmin?: FormValuesProps;
};
export default function SchoolAdminEditForm({
  isEdit = false,
  currentSchoolAdmin,
}: Props) {
  ...
  const defaultValues = useMemo(
    () => ({
      firstName: currentSchoolAdmin?.firstName || "",
      middleName: currentSchoolAdmin?.middleName || "",
      lastName: currentSchoolAdmin?.lastName || "",
      email: currentSchoolAdmin?.email || "",
      phone: currentSchoolAdmin?.phone || "",
      address: currentSchoolAdmin?.address || "",
      schoolName: currentSchoolAdmin?.schoolName || "",
      avatarUrl: currentSchoolAdmin?.avatarUrl || "",
      isVerified: currentSchoolAdmin?.isVerified || false,
    }),
    [currentSchoolAdmin]
  );
