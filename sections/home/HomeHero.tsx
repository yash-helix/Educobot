          ...
          <ContentStyle>
            ...
            <m.div variants={varFade().inRight}>
              <Typography sx={{ color: 'common.white' }}>
                eduCOBOT is an innovative way to learn coding, without long boring <br />
                videos, lectures or MCQs.
                <br />
                <br />
                Learn to code with eduCOBOT; it’s fun, immersive and visually <br />
                engaging!
                <br />
                <br />
                Take your first step towards the future with our free trial.
              </Typography>
            </m.div>
