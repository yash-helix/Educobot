...
CommendationCoins.getLayout = function getLayout(page: React.ReactElement) {
  return <Layout>{page}</Layout>;
};

export default function CommendationCoins({
  isEdit = false,
  currentTeacher,
}: Props) {
  ...
  const StudentFormSchema = Yup.object().shape({
    ...
    HowManycoins: Yup.string().required("Please select this field"),
        ...
        <Grid item xs={12} md={8}>
          <Card sx={{ p: 3 }}>
            <Stack spacing={3}>
              ...
              >
                Select if it should be coins or badges over which you would like
              ...
              <Stack>
                <RHFSelect
                  ...
                  name="HowManycoins"
                  // value={inputData.query}
                  label="How Many Coins?[should be less than 500]"
                  // onChange={handleChange}
                >
                  <MenuItem value={1}>Lesson 1</MenuItem>
                  <MenuItem value={2}>Lesson 2</MenuItem>
