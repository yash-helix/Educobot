...
CompletionCertificate.getLayout = function getLayout(page: React.ReactElement) {
...
export default function CompletionCertificate({
  ...
  const StudentFormSchema = Yup.object().shape({
    ...
    TotalLessons: Yup.string().required("Please select this field"),
    Awardaftercompleting: Yup.string().required("Please select this field"),
        ...
        <Grid item xs={12} md={8}>
          <Card sx={{ p: 3 }}>
            <Stack spacing={3}>
              ...
              >
                Select after how many lessons you would like to award this
                certificate
              </Typography>
              ...
              >
                <RHFSelect
                  ...
                  // onChange={handleChange}
                >
                  <MenuItem value={1}>150</MenuItem>
                </RHFSelect>

                <RHFSelect
                  native={false}
                  defaultValue={""}
                  name="Awardaftercompleting"
                  // value={inputData.query}
                  label="Award after completing"
                  // onChange={handleChange}
                >
                  <MenuItem value={1}>145</MenuItem>
                </RHFSelect>
              </Stack>
